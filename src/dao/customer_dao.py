...
class CustomerDAO:
    """DAO class for customer-related DB operations."""
    ...
    def customer_has_orders(self, cust_id: int) -> bool:
        resp = self.sb.table("orders").select("*").eq("cust_id", cust_id).limit(1).execute()
